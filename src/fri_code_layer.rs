...
pub fn generate_enlarged_evaluation_domain(domain_size: usize) -> Vec<FieldElement> {
    ...
    coset.iter().map(|x| g * x).collect::<Vec<FieldElement>>()//acting on the coset to have the eval_domain
}
